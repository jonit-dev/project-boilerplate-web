  ...
  return (
    <InternalPage>
      ...
      <p>
        ...
        and {appEnv.general.name}, located at {appEnv.general.address},{" "}
        {appEnv.general.province}, {appEnv.general.country} -
        {appEnv.general.zipCode} (we, us), concerning your access to and use of
        the {appEnv.general.name}
      ...
      <p>
        ...
        discontinue use immediately. We recommend that you print a copy of these
      ...
      <p>
        1.5 Our site is directed to people residing in {appEnv.general.country}.
      ...
      <p>
        ...
        include: Our <Link href="/privacy">Privacy Notice</Link>, which sets out
        the terms on which we process any personal data we collect from you, or
        that you provide to us. By using the Site, you consent to such
        ...
        this Acceptable Use Policy. Our Cookie Policy, which sets out
        information about the cookies on the Site.
      </p>
      <h4>2. Acceptable Use</h4>
      <p>
        2.1 Our full Acceptable Use Policy, sets out all the permitted uses and
      ...
      <p>
        ...
        password you must promptly notify us at {appEnv.general.adminEmail}.
      </p>
      ...
      <p>
        ...
        you upload or post content to our site, you grant us the following
        rights to use that content:
      </p>

      <p>
        4.3 In posting User Content, including reviews or making contact with
        other users of the Site you shall comply with our Acceptable Use Policy.
      </p>

      <p>
        4.4 You warrant that any User Content does comply with our Acceptable
        Use Policy, and you will be liable to us and indemnify us for any breach
      ...
      <p>
        ...
        please contact us at {appEnv.general.adminEmail} or use the take down or
        report button.
      </p>
      ...
      <p>
        5.2 Except as expressly provided in these Terms and Conditions, no part
      ...
      <h4>6. Link to third party content</h4>
      ...
      <h4>8. Modifications to and availability of the Site</h4>
      ...
      <h4>9. Disclaimer/Limitation of Liability</h4>
      ...
      <p>
        9.2 Our responsibility for loss or damage suffered by you: up to $100
        CAD. Whether you are a consumer or a business user.
      </p>
      ...
      <p>
        10.2 Without limiting any other provision of these Terms and Conditions,
