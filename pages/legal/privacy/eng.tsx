  ...
  return (
    <InternalPage>
      ...
      <p>
        ...
        {appEnv.general.name} ("Company", "we", "us", "our"). We are committed
      ...
      <p>
        ...
        interactions with us and our platform, the choices you make and the
      ...
      <p>
        ...
        navigate our platform. This information does not reveal your specific
      ...
      <ul>
        ...
        <li>
          ...
          otherwise interact with public areas of our platform , such personal
          ...
          of our and register for our through a social network (such as
          Facebook), your contacts on the social network will see your name,
      ...
      <p>
        Our servers are located in {appEnv.general.serverCountry}. If you are
        accessing our from outside, please be aware that your information may be
        ...
        (see &quot;WILL YOUR INFORMATION BE SHARED WITH ANYONE?&quot; above), in
        and other countries.
      </p>
      ...
      <p>
        ...
        years of age. By using our platform, you represent that you are at least
        18 or that you are the parent or guardian of such a minor and consent to
        such minor dependent&rsquo;s use of our platform. If we learn that
        ...
        contact us at {appEnv.general.adminEmail}.
      </p>
      ...
      <p>
        ...
        non-marketing purposes. To otherwise opt-out, you may send and e-mail to{" "}
      ...
      <p>
        ...
        registered account in our platform, you have the right to request
        removal of unwanted data that you publicly post on our platform . To
        request removal of such data, please contact us using the contact
        information provided below, and include the email address associated
        with your account and a statement that you reside in California. We will
        make sure the data is not publicly displayed on our platform, but please
